...
export function PageHero({ eyebrow, title, copy, image, imageAlt }: PageHeroProps) {
  return (
    <section className="relative isolate flex min-h-[420px] items-end overflow-hidden bg-[#061525] pt-20 md:min-h-[52vh]">
      ...
      <div
        className="absolute bottom-0 left-0 h-24 w-56 bg-[#BD1816]/90 md:h-32 md:w-72"
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-12 pt-28 sm:px-6 lg:px-8 lg:pb-14">
        <div className="max-w-2xl">
          <p className="inline-block border-l-4 border-[#BD1816] bg-white/8 px-4 py-2 text-sm font-extrabold uppercase leading-6 tracking-[0.18em] text-white backdrop-blur">
            {eyebrow}
          </p>
          <h1 className="mt-5 text-balance text-4xl font-black uppercase leading-[1.02] text-white sm:text-6xl">
            {title}
          </h1>
          <p className="mt-5 max-w-xl text-pretty text-lg font-medium leading-8 text-white/82 sm:text-xl">
            {copy}
          </p>
        </div>
      </div>
